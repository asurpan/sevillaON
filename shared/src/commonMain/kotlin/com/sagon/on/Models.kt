...
val SPAIN_CITIES = listOf(
    ...
    "CÁCERES", "SEGOVIA", "LUGO", "OURENSE", "PALENCIA", "ZAMORA", "CUENCA", "TERUEL", 
    "GUADALAJARA", "CEUTA", "MELILLA", "HUUESCA", "GUIPÚZCOA", "VIZCAYA", "LA RIOJA"
)
...
val CITY_CHANNELS = mapOf(
    ...
    "GUADALAJARA" to 7, "CEUTA" to 8, "MELILLA" to 1, "HUUESCA" to 2,
    "GUIPÚZCOA" to 32, "VIZCAYA" to 30, "LA RIOJA" to 7
)
...
data class RadioState(
    ...
    val poiSuggestions: List<RouteSuggestion> = emptyList()
)
